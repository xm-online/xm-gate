...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.icthh.xm.gate.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.icthh.xm.gate.security.DomainUserDetailsService", "createSpringSecurityUser");
