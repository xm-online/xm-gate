...
/**
 * Precompiled jhipster.docker-conventions script plugin.
 **/
public class JhipsterDockerConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_JhipsterDockerConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("com.google.cloud.tools.jib");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_JhipsterDockerConventions").asSubclass(BasicScript.class);
